...
public class LoginService {
    ...
    public ResultSet checkUserExists(String username) {
        ...
        try {
            ...
            rs =
                db1.executeQuery("SELECT USER_NAME,ORG_VALUE,PRIORITY,REPORT_NAME,BU_NAME,LEGAL_ENITY FROM Login_Details WHERE USER_NAME = '" +
                                 username + "'");
    ...
    public void getAPSupplierDetails(ResultSet rs) {
        ...
        try {
            ...
            requestURI =
                "/" + rs.getString("REPORT_NAME") + "/" + "CURRENT" + "/" + rs.getString("ORG_VALUE") + "/" + "999";
        ...
        System.out.println("Value AP Rend............" +
                           AdfmfJavaUtilities.getELValue("#{pageFlowScope.toggleBean.resultAPSupprend}"));
    ...
    public void getARDisputeDetails(ResultSet rs) {
        try {
            ...
            String requestURI =
                "/" + rs.getString("REPORT_NAME") + "/" + "CURRENT" + "/" + rs.getString("BU_NAME") + "/" +
                rs.getString("LEGAL_ENITY");
            actual_value = ss.getOutputValue(requestURI);
            ...
            System.out.println("Value AP Rend............" +
                               AdfmfJavaUtilities.getELValue("#{pageFlowScope.toggleBean.resultDisCusRend}"));
        } catch (Exception e) {
            System.out.println("Exception..." + e);
        }
    }
    ...
    public void getPendAmtReport(ResultSet rs) {
        try {
            ...
            System.out.println("getPendAmtReport Value AP Rend............" +
                               AdfmfJavaUtilities.getELValue("#{pageFlowScope.toggleBean.resultPenCusRend}"));
        } catch (Exception e) {
            System.out.println("Exception..." + e);
        }
    }
    ...
    public void getPOBackLog(ResultSet rs) {
        try {
            ...
            obj.setLe_name(rs.getString("LEGAL_ENITY"));
            String requestURI =
                "/" + rs.getString("REPORT_NAME") + "/" + rs.getString("BU_NAME") + "/" + "999" + "/" + "999";
            actual_value = ss.getOutputValue(requestURI);
            ...
            System.out.println("getPOBackLog Value AP Rend............" +
                               AdfmfJavaUtilities.getELValue("#{pageFlowScope.toggleBean.resultPOBacLogRend}"));
        } catch (Exception e) {
            System.out.println("Exception..." + e);
        }
    }
    ...
    public String getLoginCount() {
        ...
        //        System.out.println("Value username .."+AdfmfJavaUtilities.getELValue("#{pageFlowScope.username}"));                // commented by Rohit
        System.out.println("Value username .." +
                           AdfmfJavaUtilities.getELValue("#{applicationScope.username}")); // Changed the pageFlowScope >> applicationScope
        System.out.println("Value of username......" +
                           AdfmfJavaUtilities.getELValue("#{applicationScope.LoginBean.userName}"));
        //       if(AdfmfJavaUtilities.getELValue("#{pageFlowScope.username}")!=null)                  // commented by Rohit
        if (AdfmfJavaUtilities.getELValue("#{applicationScope.username}") !=
            null) // Changed the pageFlowScope >> applicationScope
        {
            //            username = AdfmfJavaUtilities.getELValue("#{pageFlowScope.username}").toString();      // commented by Rohit
            username =
